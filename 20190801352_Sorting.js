...
var siswa =
    ...
    siswa.sort(function(a, b){return a.ulang_tahunku-b.ulang_tahunku});


   for(i=0; i<siswa.length; i++) {      
        lahiran = siswa[i].ulang_tahunku;             
        var umur = parseInt((hari_ini.getYear() - lahiran.getYear()));
        console.log(siswa[i].Name + " saat ini berusia " + umur + " tahun");
     }                                       
