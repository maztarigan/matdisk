...
console.log("FIKRY  : "+Data3+" ");
console.log("JHORDY : "+Data4+" ");
console.log("KRESNA : "+Data5+" ");
console.log("SUTNA  : "+Data6+" ");
console.log("TIARA  : "+Data7+" ");
console.log("SINDY  : "+Data8+" ");
console.log("FEBRI  : "+Data9+" ");
console.log("LORENZO: "+Data10+"");
console.log("ANRIAN : "+Data11+"");
console.log("ALFIAN : "+Data12+"");
console.log("ANDRI  : "+Data13+"");
console.log("ANDROW : "+Data14+"");