...
var umur = parseInt(inputkeyboard.question("masukkan umur anda : "))


for(var i=0;i<muda.length;i++) {if(umur == muda[i][0]) {console.log("anda termasuk ke dalam kategori muda "+muda[i][1]*100+"%")}}
for(var i=0;i<paruhbaya.length;i++) { if(umur == paruhbaya[i][0]) {console.log("anda termasuk ke dalam kategori paruh baya"+paruhbaya[i][1]*100+"%")}}
for(var i=0;i<tua.length;i++) {if(umur == tua[i][0]) {console.log("anda termasuk ke dalam kategori tua "+tua[i][1]*100+"%")}}