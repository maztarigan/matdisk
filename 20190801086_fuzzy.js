...
for(var i=0; i<separuby.length; i++) {
    if(umur == separuby[i][0]) {
        console.log("Anda Setengah Baya "+separuby[i][1]*100+"%")
    }
}
...
console.log("====================================================");
console.log("creat by : Micko Tubagas");
console.log("====================================================");