console.log("Welcome");
console.log("Persentasi Umur Seseorang");
...
for(var i=0;i<muda.length;i++) {
    if(umur == muda[i][0]) {
        console.log(muda[i][1]*100+" %" + " Termasuk Muda ")
    }
}

for(var i=0;i<separuhbaya.length;i++) {
    if(umur == separuhbaya[i][0]) {
        console.log(separuhbaya[i][1]*100+" %" + " Termasuk Separuh Baya ")
    }
}

for(var i=0;i<tua.length;i++) {
    if(umur == tua[i][0]) {
        console.log(tua[i][1]*100+" %" + " Termasuk Tua ")
    }
}
