console.log("Algoritma Data Mahasiswa Kelas Karyawan EU 2019/2020");
console.log("");
...
console.log("Nama : "+alfian+"  Masuk Pukul : "+JMalfian+" WIB     Keluar Pukul : "+JKalfian+" WIB     Durasi : "+alfiantotal+" Jam  "+Totalalfian+" Menit");
