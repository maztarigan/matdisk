...
console.log("Chika : ",a[1]);
console.log("Dita : ",a[2]);
console.log("Noval : ",a[3]);
console.log("iva : ",a[4]);
console.log("Indah   : ",a[5]);
console.log("zalza : ",a[6]);
console.log("Iir  : ",a[7]);
console.log("Delia : ",a[8]);
console.log("\nTentukan Jarak Terdekat Dan Waktu Tercepat ?");
...
a[1][0] = "Chika";     a[1][1] = "Chika";
a[2][0] = "Dita";     a[2][1] =  "Dita";
a[3][0] = "Noval";      a[3][1] = "Noval";
a[4][0] = "Iva";      a[4][1]  =   "Iva";
a[5][0] = "Indah";       a[5][1] = "Indah";
a[6][0] = "Zalza";     a[6][1] = "Zalza";
a[7][0] = "Iir";       a[7][1] = "Iir";
a[8][0] = "Delia";     a[8][1] = "Delia";
